		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Attributes$placeholder('Dare to covert a string...'),
...
var _chrisbuttery$elm_convert_case$Main$camelize = function (str) {
	return A4(
		_elm_lang$core$Regex$replace,
		_elm_lang$core$Regex$All,
...
var _chrisbuttery$elm_convert_case$Main$sentencize = function (str) {
	return A4(
		_elm_lang$core$Regex$replace,
...
var _chrisbuttery$elm_convert_case$Main$titlize = function (str) {
	return A4(
		_elm_lang$core$Regex$replace,
		_elm_lang$core$Regex$All,
		_elm_lang$core$Regex$regex('\\s(\\w)'),
...
var _chrisbuttery$elm_convert_case$Main$init = function (savedModel) {
	return {
		ctor: '_Tuple2',
		_0: A2(_elm_lang$core$Maybe$withDefault, _chrisbuttery$elm_convert_case$Main$model, savedModel),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
...
var _chrisbuttery$elm_convert_case$Main$InputTitleCase = function (a) {
	return {ctor: 'InputTitleCase', _0: a};
};
var _chrisbuttery$elm_convert_case$Main$InputCamelCase = function (a) {
	return {ctor: 'InputCamelCase', _0: a};
};
var _chrisbuttery$elm_convert_case$Main$InputHyphenCase = function (a) {
	return {ctor: 'InputHyphenCase', _0: a};
};
var _chrisbuttery$elm_convert_case$Main$InputSnakeCase = function (a) {
	return {ctor: 'InputSnakeCase', _0: a};
};
var _chrisbuttery$elm_convert_case$Main$inputStringCases = _elm_lang$core$Native_List.fromArray(
	[_chrisbuttery$elm_convert_case$Main$InputSnakeCase, _chrisbuttery$elm_convert_case$Main$InputHyphenCase, _chrisbuttery$elm_convert_case$Main$InputCamelCase, _chrisbuttery$elm_convert_case$Main$InputTitleCase, _chrisbuttery$elm_convert_case$Main$InputSentenceCase]);
var _chrisbuttery$elm_convert_case$Main$view = function (model) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Elm Convert Case')
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										ctor: '_Tuple2',
										_0: 'hidden',
										_1: _elm_lang$core$Native_Utils.eq(model.conversion, '')
									}
									]))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text(model.conversion),
										A2(
										_elm_lang$html$Html$span,
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('trigger'),
												A2(_elm_lang$html$Html_Attributes$attribute, 'data-clipboard-action', 'copy'),
												A2(_elm_lang$html$Html_Attributes$attribute, 'data-clipboard-text', model.conversion)
											]),
										_elm_lang$core$Native_List.fromArray(
											[]))
									]))
...
var _chrisbuttery$elm_convert_case$Main$main = {
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					...
					A2(_elm_lang$core$Json_Decode_ops[':='], 'conversion', _elm_lang$core$Json_Decode$string),
					function (conversion) {
						return A2(
							_elm_lang$core$Json_Decode$andThen,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _chrisbuttery$elm_convert_case$Main$main === 'undefined' ? null : _chrisbuttery$elm_convert_case$Main$main);
